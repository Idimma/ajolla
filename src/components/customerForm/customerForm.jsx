  ...
  return (
    <div className="customer-form">
      ...
      {showLongitude &&
        ...
        <div className="form-row">
          <div className="form-col">
            <input type="checkbox" onChange={(e) => e.target.checked ? setFormUser(true) : setFormUser(false)} />
        ...
        <div className="form-footer">
          ...
          <span style={{marginRight: '10px'}}><CancelButton buttonText="Cancel" buttonClick={cancelBtn} /></span>
